	...
	<table cellpadding="10">
		...
		if($musteri)
		 ...
		 ?>
			...
			<tr>
				<td><div><img src="<?=$row['image_200_200']; ?>" alt=""></div></td>
				<td>Ad:</td>
...
if(isset($_POST["ad"]) && isset($_POST["soyad"]) && isset($_POST["cep"]) && isset($_POST["email"]) && isset($_POST["ek"]))
{
	...
	$update = $db->prepare("UPDATE kullanici_bilgileri SET ad=?, soyad=?, cep=?, email=?, ek=?, image_200_200=?, image_80_80=?, image_300_300=? WHERE id=?");
