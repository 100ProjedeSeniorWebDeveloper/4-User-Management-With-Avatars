...
<style>
	...
	.resim-zoom:hover{ z-index:2; -webkit-transform: scale(1.5); -ms-transform: scale(1.5); -moz-transform: scale(1.5); transform: scale(
	1.5); }
		#res{
		margin-top: -9px;
		padding-bottom: 15px;
				...
				<div class="container-fluid">
					...
					?>
							<tr>
						      ...
						      <td><img class="resim-zoom" src="user_images/<?php echo $islem['PicName'];?>" width="50" height="50" /></td>
						      <td> 		    	 
						      <a href="?sil=<?php echo $islem["id"] ?>">Sil</a>
						      <a href="guncelle.php?id=<?php echo $islem['id'] ?>">Düzenle</a>									
						      </td>
						    </tr>
					<?php 									
						}
